...
type Player = {
    ...
    current_position: number; // Parejas encontradas
    score: number;
...
export default function MemoryGameBoard({ gameId, players, totalQuestions }: MemoryGameBoardProps) {
                    ...
                    sortedPlayers.map((player, idx) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* Avatar */}
                                <div className={`relative w-11 h-11 rounded-full border-2 overflow-hidden bg-white shadow-lg shrink-0 ${
                                    isWinner ? 'border-emerald-400' : medalStyle ? medalStyle.border : 'border-white/20'
                                }`}>
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex justify-between items-center mb-1.5">
                                        <h3 className={`text-sm font-black truncate ${
                                            isWinner ? 'text-emerald-300' : medalStyle ? medalStyle.text : 'text-white/80'
                                    ...
                                    <div className="w-full bg-black/40 h-2.5 rounded-full overflow-hidden border border-white/5">
                                        <div
                                            className={`h-full transition-all duration-700 ease-out rounded-full relative ${
                                                isWinner ? 'bg-gradient-to-r from-emerald-400 to-teal-400' :
